...
class CartViewModel @Inject constructor(
    ...
    fun changeQuantity(
        ...
        /**
         * index could be equal to -1 if the function [getCartProducts] delays which will also delay the result the result we expect to be inside
         * the [_cartProducts] and to present the app from crashing  we make a check
         */
