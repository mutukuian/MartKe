...
import com.example.martke.MartApplication
...
import com.example.martke.util.validateEmail
...
class UserAccountViewModel @Inject constructor(
    ...
    private fun saveUserInformationWithnewImage(user: User, imageUri: Uri) {
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(getApplication<MartApplication>().contentResolver,
                    imageUri
                )
