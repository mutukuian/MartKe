...
class AddressViewModel @Inject constructor(
    ...
    private val _addNewAddress = MutableStateFlow<Resource<com.example.martke.data.Address>>(Resource.Unspecified())
    ...
    fun  addAddress(address: com.example.martke.data.Address){
    ...
    private fun validateInputs(address: com.example.martke.data.Address): Boolean {
